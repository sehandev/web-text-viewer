...
function get_font_info() {
    ...
    font_name_arr.some(function(tmp_font_name) {
        if (class_list.contains(tmp_font_name)) {
            font_name = tmp_font_name;
            return true;
        }
    });
    font_size_arr.some(function(tmp_font_size) {
...
$("#font-medium-button").click(function() {
...
$("#font-large-button").click(function() {
...
$("#font-xlarge-button").click(function() {
